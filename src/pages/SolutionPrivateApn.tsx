        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <Badge variant="secondary" className="mb-6">
              {t('solutions.privateApnBenefit')}
            </Badge>
            <p className="text-xl text-muted-foreground leading-relaxed">
              {t('solutions.privateApnDetail.overview')}
            </p>
          </div>
                ...
                <Card key={num} className="border-border hover:border-primary transition-colors">
                  <CardHeader>
                    <CardTitle className="flex items-start gap-3">
                      ...
                      <span>{t(`solutions.privateApnDetail.feature${num}`)}</span>
                    </CardTitle>
                  </CardHeader>
                </Card>
              ))}
                ...
                <Card key={num} className="bg-background">
                  <CardHeader>
                    <CardDescription className="text-base">
                      {t(`solutions.privateApnDetail.spec${num}`)}
                    </CardDescription>
                  </CardHeader>
                </Card>
              ))}
              ...
              {[1, 2, 3].map((num) => (
                <Card key={num} className="border-border hover:shadow-lg transition-shadow">
                  <CardHeader>
                    ...
                    <CardDescription>
                      {t(`solutions.privateApnDetail.useCase${num}`)}
                    </CardDescription>
                  </CardHeader>
                </Card>
              ))}
...
export default SolutionPrivateApn;
